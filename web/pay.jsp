<%-- 
    Document   : pay
    Created on : Sep 23, 2025, 9:24:44 AM
    Author     : admin
--%>
            ...
            <div class="la-nav-menu-items">
                ...
                <ul class="la-nav-list-items">
                    ...
                    <li class="ng-scope ng-has-child1">
                        <a href="./product.jsp">Sản phẩm <i class="fas fa-plus cong"></i> <i
                                class="fas fa-minus tru hidden"></i></a>
                        <ul class="ul-has-child1">
                            <li class="ng-scope ng-has-child2">
                                <a href="./product.jsp">Tất cả sản phẩm <i class="fas fa-plus cong1"
                            ...
                            <li class="ng-scope ng-has-child2">
                                <a href="./product.jsp">Quần áo <i class="fas fa-plus cong2"
                            ...
                            <li class="ng-scope ng-has-child2">
                                <a href="./product.jsp">Già dép<i class="fas fa-plus cong3"
                            ...
                            <li class="ng-scope ng-has-child2">
                                <a href="./product.jsp">Phụ kiện <i class="fas fa-plus cong4"
                ...
                <div class="row">
                    ...
                    <div class="col-6 login_link">
                        <ul class="header_link right m-auto">
                            ...
                            <li>
                                <a href="./register.jsp"><i class="fas fa-user-plus mr-3"
            ...
            <div class="container">
                <ul class="header_nav-list nav">
                    ...
                    <li class="header_nav-list-item has-mega">
                        <a href="./product.jsp">Sản phẩm<i class="fas fa-angle-right"
                        ...
                        <div class="mega-content" style="overflow-x: hidden;">
                          ...
                          <li class="level2"><a href="">Bóng đá</a></li>
                                ...
                                <div class="col-4">
                                    <a href="">
                                        <picture>
                                            <img src="https://media.giphy.com/media/mj7HcKFq23oobJMcOG/giphy.gif" alt=""
                                                width="80%">
                                        </picture>
                                    </a>
                                </div>
                                ...
                                <div class="main-content">
                                    ...
                                    <div class="main-customer-info">
                                        <div class="main-customer-info-img">
                                            <img src="./img/product/noavatar.png" alt="" width="60px"
                                                height="60px">
                                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div style="display: flex;justify-content:space-between;cursor: pointer;margin-bottom: 8px;"
                        ...
                        <h3 class="footer__heading">Thông tin của chúng tôi</h3><i
                            class="fas fa-chevron-down checkdl1"></i>
                    </div>
                    <ul class="footer__list collapse show" id="demo2">
                        ...
                        <li class="footer__item">
                            <a href="" class="footer__item--link">Cơ sở 2: 86 Đinh Bộ Lĩnh, P10, Quận Bình Thanh,
                                TP.HCM</a>
                        </li>
                        <li class="footer__item">
