<%-- 
    ...
    Created on : Sep 23, 2025, 9:24:39 AM
    Author     : admin
--%>
      ...
      <div class="container-fluid">
        ...
        <div class="header__third">
          <ul class="nav nav__third">
            ...
            <li class="nav-item nav-item__third">
              <a class="nav-link nav-link__third" href="./product.jsp">Tất cả sản phẩm</a>
            </li>
            <li class="nav-item nav-item__third">
      ...
      <!-- content -->
        <div class="container">
          <div class="content" style="height: 100px;box-shadow: 0 1px 6px 0 rgb(32 33 36 / 28%);margin-top: 200px;margin-bottom:200px;text-align:center">
            ...
            <a style="margin-left: 20px;font-size: 16px;" href="">Tiếp tục mua hàng</a>
          </div>
        </div>
      <!-- end content -->
      <!-- footer -->
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-3">
              ...
              <ul class="footer__list">
                <li class="footer__item">
                  <p><i class="fi-rs-marker footer__item-icon"></i> Ho Chi Minh, Viet Nam</p>
                </li>
                <li class="footer__item">
                  <p><i class="fi-rs-smartphone footer__item-icon"></i> Phone: <a href="tel:0123456789">0123456789</a></p>
                </li>
                <li class="footer__item">
                  <p><i class="fi-rs-envelope footer__item-icon"></i> Email: <a href="mailto:abc@gmail.com">abc@gmail.com</a></p>
                </li>
              </ul>
            </div>
          </div>
