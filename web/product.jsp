                                ...
                                <div class="product__color d-flex" style="align-items: center;">
                                    ...
                                    <div class="select-swap d-flex">
                                        ...
                                        <div class="circlecheck">
                                            <input type="radio" id="f-option" class="circle-1" name="selector" data-image="./img/product/ars1.jpg" checked>
                                            <label for="f-option"></label>
                                            <div class="outer-circle"></div>
                                        </div>
                                        <div class="circlecheck">
                                            <input type="radio" id="g-option" class="circle-2" name="selector" data-image="./img/product/ars2.jpg">
                                            <label for="g-option"></label>
                                            <div class="outer-circle"></div>
                                        </div>
                                        <div class="circlecheck">
                                            <input type="radio" id="h-option" class="circle-3" name="selector" data-image="./img/product/ars3.jpg">
                        ...
                        var apiproducts = [
                            {
                                ...
                                img: './img/product/nikedrifit1.jpg',
                                page: 1,
                                idsort: 'sort3',
                                idkg: 'kg1',
                                idth: 'th1',
                            ...
                            },
                            {
                                ...
                                name: 'Nike Mercurial',
                                description: 'Mới đây Footpack và Soub đã hợp tác với nhau để tạo ra một phiên bản Nike Mercurial Vapor 14 được tùy chỉnh đặc biệt',
                                img: './img/product/stansmithgolf1.jpg',
                                page: 1,
                                idsort: 'sort3',
                                idkg: 'kg1',
                                idth: 'th1',
                            ...
                            },
                            {
                                ...
                                name: 'Nike Mercurial',
                                description: 'Mới đây Footpack và Soub đã hợp tác với nhau để tạo ra một phiên bản Nike Mercurial Vapor 14 được tùy chỉnh đặc biệt',
                                img: './img/product/stansmithgolf3.jpg',
                                page: 1,
                                idsort: 'sort2',
                                idkg: 'kg2',
                                idth: 'th2',
                            ...
                            },
                            {
                                ...
                                name: 'Nike Mercurial',
                                description: 'Mới đây Footpack và Soub đã hợp tác với nhau để tạo ra một phiên bản Nike Mercurial Vapor 14 được tùy chỉnh đặc biệt',
                                img: './img/product/stansmithgolf4.jpg',
                                page: 1,
                                idsort: 'sort2',
                                idkg: 'kg3',
                                idth: 'th3',
                            ...
                            },
                            {
                                ...
                                name: 'Nike Mercurial',
                                description: 'Mới đây Footpack và Soub đã hợp tác với nhau để tạo ra một phiên bản Nike Mercurial Vapor 14 được tùy chỉnh đặc biệt',
                                img: './img/product/tuiprimegreen2.jpg',
                                page: 3,
                                idsort: 'sort3',
                                idkg: 'kg1',
                                idth: 'th1',
                            ...
                            },
                            {
                                ...
                                name: 'Nike Mercurial',
                                description: 'Mới đây Footpack và Soub đã hợp tác với nhau để tạo ra một phiên bản Nike Mercurial Vapor 14 được tùy chỉnh đặc biệt',
                                img: './img/product/tuiprimegreen3.jpg',
                                page: 3,
                                idsort: 'sort2',
                                idkg: 'kg3',
                                idth: 'th3',
...
<script>
    $(document).ready(function () {
        // Optional: If you need to do something when the modal opens, you can use this event.
        $('#myModal').on('show.bs.modal', function (event) {
            var button = $(event.relatedTarget); // Button that triggered the modal
            // You can add logic here to dynamically set the modal content based on which product was clicked
        });

        // Logic to change image based on color selection inside the modal
        $('#myModal').on('change', 'input[name="selector"]', function () {
            var newImage = $(this).data('image');
            $('#myModal #img-main').attr('src', newImage);
        });
    });
</script>
</html>
