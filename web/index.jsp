                        ...
                        <div id="demo" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./img/slideshow/1.jpg" alt="Los Angeles" width="1100" height="550">
                                    <div class="carousel-caption">
                                        <a href="./product.jsp" class="click-slideshow">Xem chi tiết</a>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img src="./img/slideshow/2.jpg" alt="Chicago" width="1100" height="550">
                                    <div class="carousel-caption">
                                        <a href="./product.jsp" class="click-slideshow">Xem chi tiết</a>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img src="./img/slideshow/3.jpg" alt="New York" width="1100" height="550">
                                    <div class="carousel-caption">
                                        <a href="./product.jsp" class="click-slideshow">Xem chi tiết</a>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-20">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/ambush1.jpg" alt="Card image cap">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-20">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/Ao_Gio_Adicolor_Classics_DJen_GN2780_21_model.jpg" alt="Card image cap">
                                        <form action="" class="hover-icon hidden-sm hidden-xs">
                                            <input type="hidden">
                                            <a href="./pay.jsp" class="btn-add-to-cart" title="Mua ngay">
                                                <i class="fas fa-cart-plus"></i>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/áo-ngực-thun-gân-medium-support-3-sọc-believe-this.jpg" alt="Card image cap">
                                        <form action="" class="hover-icon hidden-sm hidden-xs">
                                            <input type="hidden">
                                            <a href="./pay.jsp" class="btn-add-to-cart" title="Mua ngay">
                                                <i class="fas fa-cart-plus"></i>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-20">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/vaymidi1.jpg" alt="Card image cap">
                                        <form action="" class="hover-icon hidden-sm hidden-xs">
                                            <input type="hidden">
                                            <a href="./pay.jsp" class="btn-add-to-cart" title="Mua ngay">
                                                <i class="fas fa-cart-plus"></i>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-20">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/ult1.jpg" alt="Card image cap">
                                        <form action="" class="hover-icon hidden-sm hidden-xs">
                                            <input type="hidden">
                                            <a href="./pay.jsp" class="btn-add-to-cart" title="Mua ngay">
                                                <i class="fas fa-cart-plus"></i>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-20">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/tuiprimegreen1.jpg" alt="Card image cap">
                                        <form action="" class="hover-icon hidden-sm hidden-xs">
                                            <input type="hidden">
                                            <a href="./pay.jsp" class="btn-add-to-cart" title="Mua ngay">
                                                <i class="fas fa-cart-plus"></i>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/tuicheo1.jpg" alt="Card image cap">
                                        <form action="" class="hover-icon hidden-sm hidden-xs">
                                            <input type="hidden">
                                            <a href="./pay.jsp" class="btn-add-to-cart" title="Mua ngay">
                                                <i class="fas fa-cart-plus"></i>
                                    ...
                                    <div class="owl-stage">
                                        <div class="owl-item">
                                            <div class="section_policy_content">
                                                ...
                                                <img src="https://bizweb.dktcdn.net/100/344/983/themes/704702/policy_images_1.png?1628514159582" alt="">
                                        ...
                                        <div class="owl-item">
                                            <div class="section_policy_content">
                                                ...
                                                <img src="https://bizweb.dktcdn.net/100/344/983/themes/704702/policy_images_2.png?1628514159582" alt="">
                                                <div class="section-policy-padding">
                                                    <h3>Hỗ trợ 24/7</h3>
                                        ...
                                        <div class="owl-item">
                                            <div class="section_policy_content">
                                                ...
                                                <img src="	https://bizweb.dktcdn.net/100/344/983/themes/704702/policy_images_3.png?1628514159582" alt="">
                                                <div class="section-policy-padding">
                                                    <h3>Hoàn tiền 100%</h3>
                                        ...
                                        <div class="owl-item">
                                            <div class="section_policy_content">
                                                ...
                                                <img src="https://bizweb.dktcdn.net/100/344/983/themes/704702/policy_images_4.png?1628514159582" alt="">
                                                <div class="section-policy-padding">
                                                    <h3>Thanh toán</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-20">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/sandalduramo1.jpg" alt="Card image cap">
                                        <form action="" class="hover-icon hidden-sm hidden-xs">
                                            <input type="hidden">
                                            <a href="./pay.jsp" class="btn-add-to-cart" title="Mua ngay">
                                                <i class="fas fa-cart-plus"></i>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-20">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/stansmithgolf2.jpg" alt="Card image cap">
                                        <form action="" class="hover-icon hidden-sm hidden-xs">
                                            <input type="hidden">
                                            <a href="./pay.jsp" class="btn-add-to-cart" title="Mua ngay">
                                                <i class="fas fa-cart-plus"></i>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 mb-20">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/superfly1.jpg" alt="Card image cap">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <a href="./productDetail.jsp" class="product__new-item">
                                <div class="card" style="width: 100%">
                                    <div>
                                        <img class="card-img-top" src="./img/product/tatchaybo1.jpg" alt="Card image cap">
                                        <form action="" class="hover-icon hidden-sm hidden-xs">
                                            <input type="hidden">
                                            <a href="./pay.jsp" class="btn-add-to-cart" title="Mua ngay">
                                                <i class="fas fa-cart-plus"></i>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 mb-20">
                        <a href="./newDetail.jsp" class="product__new-item">
                            <div class="card" style="width: 100%">
                                <img class="card-img-top" src="./img/product/new2.jpg" alt="Card image cap" height="230px">
                                <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 mb-20">
                        <a href="./newDetail.jsp" class="product__new-item">
                            <div class="card" style="width: 100%">
                                <img class="card-img-top" src="./img/product/new1.jpg" alt="Card image cap" height="230px">
                                <div class="card-body">
                                    <h5 class="card-title description title-news">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 mb-20">
                        <a href="./newDetail.jsp" class="product__new-item">
                            <div class="card" style="width: 100%">
                                <img class="card-img-top" src="./img/product/new3.jpg" alt="Card image cap" height="230px" >
                                <div class="card-body">
                                    <h5 class="card-title description title-news">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-2 main-img-2">
                                <img src="./img/product/ars1.jpg" alt="" id="img-main" xoriginal="./img/product/ars1.jpg">
                            </div>
                            <ul class="all-img-2">
                                <li class="img-item-2">
                                    <img src="./img/product/ars1.jpg" alt="" onclick="changeImg('one')" id="one">
                                </li>
                                <li class="img-item-2">
                                    <img src="./img/product/ars2.jpg" alt="" onclick="changeImg('two')" id="two">
                                </li>
                                <li class="img-item-2">
                                    <img src="./img/product/ars3.jpg" alt="" onclick="changeImg('three')" id="three"> 
                                </li>
                                <li class="img-item-2">
                                    <img src="./img/product/ars4.jpg" alt="" onclick="changeImg('four')" id="four">
                                </li>
                            </ul>
                        </div>
                        <div class="col-6">
