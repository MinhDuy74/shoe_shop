<%-- 
    Document   : lienhe
    Created on : Sep 23, 2025, 9:23:58 AM
    Author     : admin
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-6 login_link">
                        <!-- <ul class="header_link right m-auto">
                            <li>
                                <a href=""><i class="fas fa-sign-in-alt mr-3"></i>Đăng nhập</a>
                            </li>
                            <li>
                                <a href=""><i class="fas fa-user-plus mr-3" style="margin-left: 10px;"></i>Đăng kí</a>
                            </li>
                        </ul> -->
        ...
        <nav class="header_nav hidden-sm hidden-xs">
            <div class="container">
                <ul class="header_nav-list nav">
                    ...
                    <li class="header_nav-list-item"><a href="./Login.jsp">Giới thiệu</a></li>
                    <li class="header_nav-list-item has-mega">
                        ...
                        <li class="level2"><a href="">Bóng đá</a></li>
                                    ...
                                    <li class="level1">
                                        ...
                                        <ul class="level1">
                                            <li class="level2"><a href="">Bóng đá</a></li>
                                            <li class="level2"><a href="">Chạy</a></li>
                                            <li class="level2"><a href="">Cầu lông</a></li>
                                            <li class="level2"><a href="">Bóng rổ</a></li>
                                            <li class="level2"><a href="">Quần vợt</a></li>
                                        </ul>
                                    </li>
                                    <li class="level1">
                                    ...
                                    <li class="level1">
                                        ...
                                        <ul class="level1">
                                            ...
                                            <li class="level2"><a href="">Bóng rổ</a></li>
                                            <li class="level2"><a href="">Quần vợt</a></li>
                                            <li class="level2"><a href="">Bơi lội</a></li>
                                            <li class="level2"><a href="">Golf</a></li>
                                        </ul>
                                    </li>
                                </ul>
                                <div class="col-4">
                                    <a href="">
                                        <picture>
                                            <img src="./img/product/giayxah2.jpg" alt="" width="100%">
                                        </picture>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    ...
                    <ul class="footer__list collapse show" id="demo2">
                        ...
                        <li class="footer__item">
                            <a href="" class="footer__item--link">Cơ sở 2: 86 Đinh Bộ Lĩnh, P26, Quận Bình Thanh,
                                TP.HCM</a>
                        </li>
                        <li class="footer__item">
